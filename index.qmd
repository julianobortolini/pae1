...
-   Aula 2: análise de variância, comparações multiplas, teste Tukey para comparação múltipla e exemplos. [Tabela q (Tukey)](tab_q_tukey.pdf). [Tabela F (5%)](tab_F_5.pdf).
